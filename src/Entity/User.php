...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[ORM\OneToMany(mappedBy: 'pseudo', targetEntity: Messenger::class)]
    private $messengers;

    #[ORM\OneToMany(mappedBy: 'pseudo', targetEntity: Recipes::class)]
    private $recipes;
    ...
    public function removeMessenger(Messenger $messenger): self
    {
        if ($this->messengers->removeElement($messenger)) {
            ...
            if ($messenger->getPseudo() === $this) {
                $messenger->setPseudo(null);
            }
        }
    ...
    public function removeRecipe(Recipes $recipe): self
    {
        if ($this->recipes->removeElement($recipe)) {
            // set the owning side to null (unless already changed)
            if ($recipe->getPseudo() === $this) {
                $recipe->setPseudo(null);
            }
        }
